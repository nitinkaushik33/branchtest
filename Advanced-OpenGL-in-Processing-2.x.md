This page is about Processing 2, which is no longer supported or developed. Please see [this page](https://github.com/processing/processing/wiki/Advanced-OpenGL) for an up-to-date version of this page that applies to Processing 3.

The OpenGL renderer in Processing 2 uses JOGL 2, which introduced the concept of [profiles](http://jogamp.org/jogl/doc/Overview-OpenGL-Evolution-And-JOGL.html) to access different versions of the GL API. The GL2 profile is probably the one you want to use if you were working with low-level GL in Processing 1.x, since it offers backwards compatibility with Open GL 1.x (i.e.: fixed function pipeline), while supporting shaders and other more recent functionality. 
